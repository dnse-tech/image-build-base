...
ARG TRIVY_VERSION=0.68.2
RUN set -ex; \
    wget -q "https://github.com/aquasecurity/trivy/releases/download/v${TRIVY_VERSION}/trivy_${TRIVY_VERSION}_Linux-s390x.tar.gz"; \
    tar -xzf trivy_${TRIVY_VERSION}_Linux-s390x.tar.gz; \
    mv trivy /usr/local/bin
